...
RETURNS TABLE (
    ...
    total_message_token_count BIGINT,
    total_prompt_token_count BIGINT,
    total_completion_token_count BIGINT,
    total_system_prompt_token_count BIGINT,
    total_history_token_count BIGINT,
    total_tool_def_token_count BIGINT,
    total_user_msg_token_count BIGINT,
    total_bot_response_token_count BIGINT,
...
RETURNS TABLE (
    ...
    file_size BIGINT,
    char_count BIGINT,
    filestore_character_count BIGINT,
