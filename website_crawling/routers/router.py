...
@router.post("/api/v1/webcrawl/scrape")
...
@router.get("/api/v1/webcrawl/scrape/jobs")
...
@router.get("/api/v1/webcrawl/scrape/jobs/{job_id}")
...
@router.delete("/api/v1/webcrawl/scrape/jobs/{job_id}")
...
@router.post("/api/v1/webcrawl/crawl")
...
@router.get("/api/v1/webcrawl/crawl/sessions")
...
@router.get("/api/v1/webcrawl/crawl/sessions/{session_id}")
...
@router.post("/api/v1/webcrawl/crawl/sessions/{session_id}/stop")
...
@router.get("/api/v1/webcrawl/scrape/jobs/{job_id}/content")
...
@router.get("/api/v1/webcrawl/search")
...
@router.get("/api/v1/webcrawl/analytics/scraping")
...
@router.get("/api/v1/webcrawl/analytics/domains")
...
@router.get("/api/v1/webcrawl/health")
