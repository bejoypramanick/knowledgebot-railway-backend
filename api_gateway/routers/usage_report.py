...
function toggleSession(rowEl, sessionId) {
  ...
  msgs.forEach(m => {
    ...
    if(hasBreakdown || hasBotBreakdown) {
      ...
      if(m.role==='user') {
        bdRow.innerHTML = `<td colspan="9" style="padding-left:32px;font-size:11px;color:var(--muted)">
