...
@router.get("/chatbot/chat/history/{session_id}")
...
@router.delete("/chatbot/chat/session/{session_id}")
...
@router.post("/chatbot/chat/session")
...
@router.get("/chatbot/chat/sessions")
...
@router.get("/chatbot/agents/{agent_id}")
