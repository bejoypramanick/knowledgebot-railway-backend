...
@router.post("/api/v1/chatbot/chat")
...
@router.get("/api/v1/chatbot/chat/history/{session_id}")
...
@router.delete("/api/v1/chatbot/chat/session/{session_id}")
...
@router.post("/api/v1/chatbot/chat/session")
...
@router.get("/api/v1/chatbot/chat/sessions")
...
@router.get("/api/v1/chatbot/agents")
...
@router.get("/api/v1/chatbot/agents/{agent_id}")
